...
pub async fn load_cfd_by_order_id(
    ...
    let row = sqlx::query!(
        ...
        select
            ...
            cfds.min_quantity as "min_quantity: crate::model::Usd",
            cfds.max_quantity as "max_quantity: crate::model::Usd",
            cfds.leverage as "leverage: crate::model::Leverage",
            cfds.liquidation_price as "liquidation_price: crate::model::Price",
            cfds.creation_timestamp_seconds as "ts_secs: crate::model::Timestamp",
            cfds.term_seconds as "settlement_time_interval_secs: i64",
